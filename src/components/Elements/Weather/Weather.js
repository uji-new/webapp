...
export const Weather = (props) => {
    ...
    var rainProb = (rain) => {
        let oldMax = 1; let oldMin = 0;
        let nMax = 100; let nMin = 0;
        return (nMax-nMin)/(oldMax-oldMin)*(rain-oldMin)-nMin;
    };
    var mS_to_kmH = (velocity) => {
        return (velocity * 3.6).toLocaleString(undefined, {style: 'decimal', minimumFractionDigits: 0,
    ...
    return (
        <div className="widget">            
            ...
            <Card className="left-panel panel">
                <Card.Body>
